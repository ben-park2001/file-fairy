...
from models.schema import GenerateNameResponse
...
def generate_new_filename(
    ...
    5. Return suggestion with confidence score and reasoning
...
def batch_rename_files(
    ...
    for file_path in file_paths:
        try:
            suggestion = generate_new_filename(file_path, context, preserve_extension=True)
